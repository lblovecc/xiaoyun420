 ...
 * 图像处理方法
 * @author qam
 * @time 2015年5月19日 下午2:38:58
 */
public class ScaleImage {

	private static final Logger logger = LoggerFactory.getLogger(ScaleImage.class);
	...
	public BufferedImage imageZoomOut(BufferedImage bufferedImage,int w,int h) {
		...
		BufferedImage pbOut = HorizontalFiltering(bufferedImage,w);
	...
	private void CalContrib() {
		...
		try{
			...
			logger.info("init contrib , normContrib , tmpContrib " + e);
		}
	...
	private int HorizontalFilter(BufferedImage bufImage, int startX, int stopX, 
